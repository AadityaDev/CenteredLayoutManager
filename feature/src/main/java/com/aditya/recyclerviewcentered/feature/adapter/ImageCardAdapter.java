package com.aditya.recyclerviewcentered.feature.adapter;
...
import com.aditya.recyclerviewcentered.BuildConfig;
import com.aditya.recyclerviewcentered.feature.R;
...
public class ImageCardAdapter extends RecyclerView.Adapter<ImageCardAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recycle_card, parent, false);
